    ...
    if seats>0 and seats<17:
        ...
        return f"""
               <svg xmlns="http://www.w3.org/2000/svg" width="60" height="50" viewBox="0 0 60 50" fill="none">
                    ...
                    <text x="26" y="30" text-anchor="middle" font-family="Frutiger" font-size="16" font-weight="bold" fill="black">{lblUtil}</text>
        ...
        return f"""
               <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 60 60" fill="none">
                ...
                <text x="30" y="40" text-anchor="middle" font-family="Frutiger" font-size="16" font-weight="bold" fill="black">{lblUtil}</text>
        ...
        return f""" 
             <svg xmlns="http://www.w3.org/2000/svg" width="60" height="70" viewBox="0 0 60 70" fill="none">
                ...
                <text x="30" y="50" text-anchor="middle" font-family="Frutiger" font-size="16" font-weight="bold" fill="black">{lblUtil}</text>
        ...
        return f"""
                <svg xmlns="http://www.w3.org/2000/svg" width="72" height="80" viewBox="0 0 72 80" fill="none">
                    ...
                    <text x="36" y="60" text-anchor="middle" font-family="Frutiger" font-size="16" font-weight="bold" fill="black">{lblUtil}</text>
        ...
        return f"""
                ...
                <text x="50" y="60" text-anchor="middle" font-family="Frutiger" font-size="16" font-weight="bold" fill="black">{lblUtil}</text>
